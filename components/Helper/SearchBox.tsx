    ...
    <div className='bg-white rounded-lg p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 items-center justify-center gap-8 mt-4 sm:mt-12 w-[95%] sm:w-[80%]'>
      ...
      <div className='flex items-center space-x-6'>
        ...
        <div>
            ...
            <input type="text" placeholder='Where are you going?' className='text-base xl:text-xs outline-none border-none placeholder:text-gray-800' />
        </div>
      </div>
       {/* 2nd search input */}
       <div className='flex items-center space-x-6'>
        ...
        <div>
            ...
            <input type="date" className='text-base xl:text-xs outline-none border-none' />
        </div>
      </div>
       {/* 3rd search input */}
       <div className='flex items-center space-x-6'>
       ...
       <div className='flex items-center space-x-6'>
        ...
        <div>
            ...
            <p className='text-base xl:text-xs font-normal'>1 Guest 1 Room</p>
        </div>
      </div>
    </div>
  )
