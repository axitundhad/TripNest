"use client";
import { navLinks } from "@/constanst/constant";
    ...
    >
      <div className="flex items-center h-full justify-between w-[90%] xl:w-[80%] mx-auto">
        ...
        <div className="flex items-center space-x-1 md:space-x-2">
          <div className="size-8 md:size-10 bg-rose-500 rounded-full flex items-center justify-center flex-col">
            <TbAirBalloon className="w-6 h-6 text-white" />
          </div>
          <h1 className="text-[16px]  md:text-2xl text-white uppercase font-bold">
            TripNest
          </h1>
        </div>
